...
EXECUTE CanHoliday 2,'1990-10-01','1989-12-01';
--print(@result);
--SELECT * FROM StuffDepartment
--INSERT INTO StuffDepartment (department,employee,post,bonusPay,begWork,endWork)
--VALUES (5,3,3,3000,'1990-01-02','1990-01-02')
--Point 1
