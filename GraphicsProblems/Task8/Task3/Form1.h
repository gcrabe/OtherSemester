...
#pragma endregion
	...
	private: System::Void Form1_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
				 ...
				 case Keys::R: 
					 {
						rotateCenter(0.05f, Form::ClientRectangle.Width, Form::ClientRectangle.Height, R, T, T1, true); 
						break;
					 }
				 case Keys::Y: 
					 {
						rotateCenter(0.05f, Form::ClientRectangle.Width, Form::ClientRectangle.Height, R, T, T1, false); 
						break;
					 }
				 case Keys::C: 
					 {
				 ...
				 case Keys::K: 
					 {
						scaleAxes(1 / 1.1, 0, Form::ClientRectangle.Height, Form::ClientRectangle.Width,
							Form::ClientRectangle.Height, R, T, T1, true);
						break;
					 }
				 case Keys::L: 
					 {
						scaleAxes(1.1, 0, Form::ClientRectangle.Height, Form::ClientRectangle.Width,
							Form::ClientRectangle.Height, R, T, T1, true); 
						break;
					 }
				 case Keys::Escape: 
